...
public class ExperienceHandler : MonoBehaviour
{
    ...
    private void addAllSkills()
    {
        ...
        allSkills.Add (new Skill ("ShrapnelShot", WeaponTypes.ShotGun, ""));
        ...
        allSkills.Add(new Skill("MultiShot", WeaponTypes.MachineGun, "Fire one, fire two, or why not more? By adding on this skill you will quickly find out that one muzzle can do the work of several."));
